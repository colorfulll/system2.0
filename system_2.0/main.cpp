...
{
    block4->begin();
    { Fl_Button* o = btnTest = new Fl_Button(10, 40, 60, 25, "item");
      o->callback((Fl_Callback*)dt_callback, (void*)("item"));
    }
    { Fl_Button* o = btnTest = new Fl_Button(100, 40, 60, 25, "food");
      o->callback((Fl_Callback*)dt_callback, (void*)("food"));
    }
    { Fl_Return_Button* o = btnClose = new Fl_Return_Button(190, 40 , 60, 25, "book");
